...
[![Docker Pulls](https://img.shields.io/docker/pulls/ctran/minecraft-server.svg)](https://hub.docker.com/r/ctran/minecraft-server/)
[![Docker Stars](https://img.shields.io/docker/stars/ctran/minecraft-server.svg?maxAge=2592000)](https://hub.docker.com/r/ctran/minecraft-server/)
...
To simply use the latest stable version, run
    ...
    docker run -d -p 25565:25565 --name mc ctran/minecraft-server
...
In order to attach and interact with the Minecraft server, add `-it` when starting the container, such as
    ...
    docker run -d -it -p 25565:25565 --name mc ctran/minecraft-server
...
such as
        ...
        docker run -d -it -e EULA=TRUE -p 25565:25565 --name mc ctran/minecraft-server
...
but you can also choose to run a specific version with `-e FORGEVERSION=10.13.4.1448`.
    ...
    $ docker run -d -v /path/on/host:/data -e VERSION=1.7.10 \
        ...
        -p 25565:25565 -e EULA=TRUE --name mc ctran/minecraft-server
...
pass `--noconsole` at the very end of the command line and not use `-it`. For example,
    ...
    docker run -d -v /path/on/host:/data \
        -e TYPE=SPIGOT -e VERSION=1.8 \
        -p 25565:25565 -e EULA=TRUE --name mc ctran/minecraft-server --noconsole
